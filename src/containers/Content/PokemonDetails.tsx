...
import Image from '../../components/Content/PokemonDetails/Image';
import HealthAndCombatPoints from '../../components/Content/PokemonDetails/HealthAndCombatPoints';
import WeightAndHeightPoints from '../../components/Content/PokemonDetails/WeightAndHeightPoints';
...
export class PokemonDetails extends Component<any> {
  constructor(props) {
    super(props);
  }
